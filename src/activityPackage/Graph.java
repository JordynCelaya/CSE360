...
public class Graph {
      ...
      * 
      */
     public void graphify() throws StandaloneNodeException {
     ...
     public List<String> getPaths() throws CycleException, StandaloneNodeException {
    	 ...
    	 // Order lists by duration
    	 Collections.sort(paths, (path1, path2) -> {
    		 int duration1, duration2;
    		 duration1 = Integer.parseInt((path1).split(": ")[1]);
    		 duration2 = Integer.parseInt((path2).split(": ")[1]);
